---
name: add-photo
description: 85mm 연습장(redjade.github.io/85mm)에 사진을 올린다. 원본 사진 파일이나 폴더를 받아 웹용 사본(긴 변 2400px, 메타데이터·GPS 제거)과 기록 초안을 만들고, 사용자와 함께 메모(보았다/생략했다, 거리, 분위기, 여섯 개의 단어, 연습)를 채운 뒤 빌드하고 확인을 받아 배포한다. "사진 올려줘", "기록 추가", "이 사진들 올려" 같은 요청에 쓴다.
---
